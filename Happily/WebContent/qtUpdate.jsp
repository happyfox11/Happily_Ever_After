				...
				<article>
					...
					<div id="box1">
						<%
							...
							if(rs.next()){
						%>		
								<form action="qtUpdateProcess.jsp" method="post">
									<table width="700px">
										<tr>
										...
										<tr>
											<td width="100"> 작성자</td>
											<td align="left">
												<input type="text" name="q_name" value="<%=rs.getString("q_name")%>">
											</td>
										</tr>
										<tr>
											<td width="100"> qt 다이어리</td>
											<td align="left">
												<textarea name="q_memo"  style="width:550px;height:300px;resize:none"><%=rs.getString("q_memo")%></textarea>
											</td>
										</tr>
										<tr>
											<td width="100"> 작성일</td>
										...
										<tr>
											<td colspan="2">
												<input type="submit"  class="link but1" value="수정하기">
